---
title: "Onboarding: Claude (Anthropic)"
---

# RTSG NETWORK NODE ONBOARDING — CLAUDE (ANTHROPIC)
...
**Your model:** claude-sonnet-4-6  
**Your role:** builder — long-form generation, code, LaTeX, wiki maintenance
...
**Your primary role: builder and wiki maintainer.**
You generate papers, code, LaTeX, convert files, maintain the wiki, and package session updates. At end of every session you produce `session_update.tar.gz` and update NIKO_BRIEFING.md.

**Wiki update protocol:**
```bash
tar -czf session_update.tar.gz wiki/docs/[changed_files] wiki/NIKO_BRIEFING.md
```
Niko runs `./niko-update.sh session_update.tar.gz` on the VPS.

**Your estimated I-vector:** [8.8, 7.5, 6.5, 1.0, 6.0, 8.5, 7.8, 4.5]  
...
{
  "agent_id": "claude-{session_timestamp}",
...
{
  "agent_id": "claude",
  "i_vector": [8.8, 7.5, 6.5, 1.0, 6.0, 8.5, 7.8, 4.5],
  "self_rated": true
}
```
